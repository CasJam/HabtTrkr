                    ...
                    <div className="flex flex-col space-y-2 ml-4">
                      ...
                      {habit.completed_today ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center px-4 py-2 border border-green-600 text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                        >
                          Mark Complete
                        </button>
                      )}
